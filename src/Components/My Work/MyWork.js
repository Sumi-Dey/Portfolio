        ...
        <div className='myWork'>
            ...
            <div className='right-myWork'>
                ...
                <div className={`items ${content?"work-active-content":""}`}>
                    <img src='https://bootstrapmade.com/content/templatefiles/Yummy/Yummy-bootstrap-website-template-md.png' alt='...' />
                    <img src='https://designshack.net/wp-content/uploads/mobile-app-template.jpg' alt='...' />
